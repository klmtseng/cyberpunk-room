...
|---|---|---|---|
| `leather_white` | `public/assets/textures/sofa/leather_white_diff_1k.webp` (+ `nor_gl`, `rough`; converted from original 1K JPGs) | 2026-06-15 | <https://polyhaven.com/a/leather_white> |
...
- `public/assets/textures/lantern_mosaic*.webp` — procedurally generated by `tools/lantern/build_mosaic.py` (converted to WebP by `tools/webp_convert.py`)
- `public/assets/textures/desk_lantern_mosaic*.webp` — extracted from project owner's own photos (converted to WebP by `tools/webp_convert.py`)
